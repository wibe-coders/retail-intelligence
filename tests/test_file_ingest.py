...
from retail_intelligence.domain.media import Completeness, RetentionClass, Source, SourceClock, SourceReference
...
class FileIngestTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.source = Source(
            ...
            RetentionClass.STANDARD, "sha256:abc", 6, self.clock,
        )
    ...
    def test_registration_preserves_file_metadata_and_is_idempotent(self) -> None:
        ...
        self.assertEqual(stored.frame_count, 6)
    ...
    def test_conflicting_duplicate_source_identifier_fails_without_replacement(self) -> None:
        ...
        conflicting = Source(
            ...
            1280, 720, 24, RetentionClass.ARCHIVE, "sha256:different", 6, self.clock,
        )
